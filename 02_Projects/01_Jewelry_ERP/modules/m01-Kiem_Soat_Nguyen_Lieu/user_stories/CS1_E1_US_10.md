# 🏷️ [CS1.E1.US-10] Nhận NL khách - Kiểm tra: chênh lệch Kiểm tem - Tính đá & Gửi thông báo
...
- **Given (Biết rằng):** Sau khi nhân viên xác nhận ở Modal "Kiểm tem - Tính đá". Hệ thống đã xác định:
  - Chênh lệch vượt ngưỡng (TL chênh lệch = `"TL đá khách" - "TL đá Seva"` > Chênh lệch cấu hình).
  - HOẶC, có sai tem.
...
Dưới đây là 3 kịch bản hiển thị lý do tương ứng với dữ liệu thực tế từ Kiểm tem - Tính đá:
  - **Kịch bản A: Chỉ vi phạm Vượt ngưỡng (Threshold Violation)**
    ...
    - **Ví dụ:** Chênh lệch TL đá 0.5214 (Vượt ngưỡng 0.3000)
