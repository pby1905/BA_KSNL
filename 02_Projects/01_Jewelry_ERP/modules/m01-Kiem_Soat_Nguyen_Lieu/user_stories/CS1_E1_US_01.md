# 🏷️ [CS1.E1.US-01] Nhận NL khách - Tạo, lưu, lưu nháp, in nhãn
...
### AC 1: Tạo mới phiếu tiếp nhận thành công (Lưu)
- **Given (Biết rằng):** Nhân viên tiếp nhận đang ở màn hình "Tạo phiếu tiếp nhận NL".
...
### AC 2: Tính toán chênh lệch trọng lượng tự động
- **Given (Biết rằng):** Nhân viên đang nhập thông diễn tại phần "Xác nhận bao bì".
...
### AC 3: Lưu nháp phiếu tiếp nhận
- **Given (Biết rằng):** Nhân viên đã nhập một phần thông tin nhưng chưa xong.
...
### AC 4: Lưu & In nhãn thành công
- **Given (Biết rằng):** Nhân viên đã nhập đầy đủ thông tin bắt buộc.
...
### AC 5: Kiểm tra bỏ trống trường bắt buộc
- **Given (Biết rằng):** Nhân viên để trống các trường có dấu (*).
...
- **BR-01:** Mã phiếu tiếp nhận được hệ thống sinh tự động (tham chiếu → Phụ lục A - Mã hóa) và duy nhất.
...
- Định dạng trọng lượng: Cho phép nhập tối đa 4 chữ số thập phân (đặc thù ngành vàng cần độ chính xác cao).
...
## 6. GHI CHÚ CHO QC
- Kiểm tra logic tính toán trường "Chênh lệch" với cả số dương và số âm.
